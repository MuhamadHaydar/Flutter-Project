...
class _SettingsState extends State<Settings> {
  ...
  void initState() {
    ...
    // Read the settings from the shared preference and set to the
    // text fields.
    readSettings();
    super.initState();
  }
  ...
  /*
  In short, this function reads the values of the settings from SharedPreferences,
  ...
  /*
  This method reads the value of the key that was passed and
  adds the value(+1 or -1).
   */
